...
const faqs = [

    {
        ...
        respuesta: "Puedes utilizar la herramienta de búsqueda en la sección 'Buscar Profesores' y filtrar los resultados según la materia, nivel educativo, ubicación, precio y disponibilidad."
    },
    {
    ...
    
    {
        ...
        respuesta: "Para registrarte como profesor, haz clic en 'Registro' y selecciona la opción para profesores. Completa el formulario con tu información y sube los documentos necesarios para verificar tu identidad y calificaciones."
    },
        ...
        <div className="container mx-auto p-4 max-w-full w-full">
                ...
                <div className="w-full px-4">
                    <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
                        ...
                        <p className="text-base text-body-color dark:text-dark-6">
                            Aquí encontrarás las preguntas más frecuentes que nuestros usuarios nos hacen.
                        </p>
                    </div>
                </div>
            </div>
            <div className="w-full px-4">
                <div className="space-y-4 max-w-[520px] mx-auto">
                    {faqs.map((faq, index) => (
                        <details key={index} className="group [&_summary::-webkit-details-marker]:hidden" open>
                            <summary
